    ...
    return (
        <div className="card-sign card-up">
            ...
            >
                ...
                <p>
                    Welcome to AirScrum! These terms and conditions outline the
                    rules and regulations for the use of AirScrum's Website,
                    located at www.airscrum.com. By accessing this website we
                    assume you accept these terms and conditions. Do not
                    continue to use AirScrum if you do not agree to take all of
                ...
                <h3>Cookies</h3>
                <p>
                    We employ the use of cookies. By accessing AirScrum, you
                    agreed to use cookies in agreement with the AirScrum's
                ...
                <h3>License</h3>
                <p>
                    Unless otherwise stated, AirScrum and/or its licensors own
                    the intellectual property rights for all material on
                    AirScrum. All intellectual property rights are reserved. You
                    may access this from AirScrum for your own personal use
                    ...
                    <ul>
                        ...
                        <li>
                            You hereby grant AirScrum a non-exclusive license to
